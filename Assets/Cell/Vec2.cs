...
namespace Cell {
	...
	public struct Vec2 : IEquatable<Vec2> {
		...
		public static Vec2 positiveInfinity = new Vec2(double.PositiveInfinity, double.PositiveInfinity);
		public static Vec2 negativeInfinity = new Vec2(double.NegativeInfinity, double.NegativeInfinity);
